...
interface Routine {
	...
	*/
	( order: Layout, M: number, N: number, k: number, A: Float64Array, LDA: number, B: Float64Array, LDB: number ): Float64Array;
	...
	* // B => <Float64Array>[ 1.0, 2.0, 0.0, 4.0 ]
	*/
	ndarray( M: number, N: number, k: number, A: Float64Array, strideA1: number, strideA2: number, offsetA: number, B: Float64Array, strideB1: number, strideB2: number, offsetB: number ): Float64Array;
}
