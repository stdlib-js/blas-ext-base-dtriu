...
```bash
npm install @stdlib/blas-ext-base-dtriu
```
...
```c
void stdlib_strided_dtriu( const CBLAS_LAYOUT layout, const CBLAS_INT M, const CBLAS_INT N, const CBLAS_INT k, const double *A, const CBLAS_INT LDA, double *B, const CBLAS_INT LDB );
```
...
```c
void stdlib_strided_dtriu_ndarray( const CBLAS_INT M, const CBLAS_INT N, const CBLAS_INT k, const double *A, const CBLAS_INT strideA1, const CBLAS_INT strideA2, const CBLAS_INT offsetA, double *B, const CBLAS_INT strideB1, const CBLAS_INT strideB2, const CBLAS_INT offsetB );
```
...
[npm-image]: http://img.shields.io/npm/v/@stdlib/blas-ext-base-dtriu.svg
[npm-url]: https://npmjs.org/package/@stdlib/blas-ext-base-dtriu

[test-image]: https://github.com/stdlib-js/blas-ext-base-dtriu/actions/workflows/test.yml/badge.svg?branch=main
[test-url]: https://github.com/stdlib-js/blas-ext-base-dtriu/actions/workflows/test.yml?query=branch:main

[coverage-image]: https://img.shields.io/codecov/c/github/stdlib-js/blas-ext-base-dtriu/main.svg
[coverage-url]: https://codecov.io/github/stdlib-js/blas-ext-base-dtriu?branch=main

<!--

[dependencies-image]: https://img.shields.io/david/stdlib-js/blas-ext-base-dtriu.svg
[dependencies-url]: https://david-dm.org/stdlib-js/blas-ext-base-dtriu/main
...
[deno-url]: https://github.com/stdlib-js/blas-ext-base-dtriu/tree/deno
[deno-readme]: https://github.com/stdlib-js/blas-ext-base-dtriu/blob/deno/README.md
[umd-url]: https://github.com/stdlib-js/blas-ext-base-dtriu/tree/umd
[umd-readme]: https://github.com/stdlib-js/blas-ext-base-dtriu/blob/umd/README.md
[esm-url]: https://github.com/stdlib-js/blas-ext-base-dtriu/tree/esm
[esm-readme]: https://github.com/stdlib-js/blas-ext-base-dtriu/blob/esm/README.md
[branches-url]: https://github.com/stdlib-js/blas-ext-base-dtriu/blob/main/branches.md

[stdlib-license]: https://raw.githubusercontent.com/stdlib-js/blas-ext-base-dtriu/main/LICENSE
