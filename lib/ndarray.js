...
* var B = new Float64Array( [ 0.0, 0.0, 0.0, 0.0 ] );
*
* dtriu( 2, 2, -1, A, 2, 1, 0, B, 2, 1, 0 );
* // B => <Float64Array>[ 1.0, 2.0, 3.0, 4.0 ]
*/
function dtriu( M, N, k, A, strideA1, strideA2, offsetA, B, strideB1, strideB2, offsetB ) { // eslint-disable-line max-len, max-params
